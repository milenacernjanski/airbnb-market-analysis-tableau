...
This project analyzes Airbnb listings to help a potential guest or investor understand pricing, location, and property characteristics before choosing an area to stay in. The analysis is built in Tableau using cleaned and joined Airbnb datasets, with a focus on 2016 data only.
...
Filtered dataset to only include 2016 data
...
This project demonstrates the importance of understanding data structure, not just visualizing it. By manually validating joins, filtering irrelevant data, and designing visuals around a real user question, the dashboard delivers insights that are both accurate and actionable.
